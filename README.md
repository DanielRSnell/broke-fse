...
**Website:** [umbral.ai](https://umbral.ai)
**Author:** Daniel Snell
...
git clone https://github.com/DanielRSnell/umbral.git wp-content/themes/your-theme
cd wp-content/themes/your-theme
./setup.sh
```
...
git clone https://github.com/DanielRSnell/umbral.git broke
cd broke
composer install
pnpm install
pnpm run build:css
